...
public static void main(String[] args) {
    ...
    while (escalonador.getProcessos().size() > 0) {
        ...
        if(escalonador.getProntos().isEmpty()==false) {
            bcp = ((TreeSet<BCP>) escalonador.listaProntos).last();
            ...
            while ((contaInstrucoes < bcp.getQuantum() * escalonador.N_COM) && (bcp.getStatusProcesso() == 'E')
                ...
                finalizado = escalonador.interpretaCodigo(bcp, contaInstrucoes);
            ...
            if (finalizado == false) {
                ...
                contaTrocas++;
                escalonador.listaProntos = escalonador.reordena();
            }
        }
        else {
            escalonador.decrementaTempBloqueados();
